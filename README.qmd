...
This repo takes the [M3](https://www.sciencedirect.com/science/article/abs/pii/S0169207000000571) competition's data and builds 7 different models:
...
-   Theta
-   Median, Frourier Functions, Linear Trend, Exponential Smoothing (MFLES)
...
The seasonal naive model did surprisingly well. However, all 6 statistical models were able to beat it. Error Trend Seasonality is the best model.
